...
* uniqueId[0].type = #uri
* uniqueId[0].value = $csTipoLogradouro
...
* usage = "Identificação dos detalhes de um logradouro em um endereço completo."

CodeSystem: TipoLogradouro
Id: tipo-logradouro
Title: "Tipo de Logradouro"
Description: """Classificação os tipos de logradouros existentes para uso em endereços estruturados."""
