...
echo "Validando"
java -jar validador/validator_cli.jar fsh-generated/resources/*.json -version 4.0.1 -ig br.ufg.cgis.rnds-lite#0.1.3 | GREP_COLORS='mt=01;31:ms=01;31' grep -B 1 -A 4 --color=always "[1-9][0-9]* errors"
